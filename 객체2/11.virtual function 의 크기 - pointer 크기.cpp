...
int main(void) {
	...
	cout << "class size : " << sizeof(v1) << endl;
	cout << "class size : " << sizeof(v2) << endl;
	cout << "class size : " << sizeof(v3) << endl;
	cout << "class size : " << sizeof(v4) << endl;
	cout << "class size : " << sizeof(v5) << endl;
